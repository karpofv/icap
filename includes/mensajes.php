...
Class MensajesCorreo {
    function bandejaMensajes($cedula,$cuantos) {
        ?>
        <div class="content-box">
                ...
                <div class="mail-toolbar clearfix">
                    <div class="float-left">
                        <a title="Recargar" onclick="$.ajax({ type: 'POST', url: 'recargar.php',
                ...
                <table class="table table-hover text-center">
                    <tbody>
                        ...
                        foreach ($res_ as $rowp ) {
                            $conex= $rowp["id"];$Asunto=$rowp["Asunto"];
                            $Datosquien="Hever Escolcha";
                            $resaltar='';$marca='';
                            if($Asunto==''){ $Asunto='Sin asunto'; }
                            if($rowp[Status]==0){ $resaltar="font-weight: 800;"; $marca="<span class='bs-label bg-orange tooltip-button'  title='mensaje nuevo'>New</span>"; }
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($rowp[Destacado]=='0'){ ?>
                                        <a title="Destacar" onclick="$.ajax({ type: 'POST', url: 'recargar.php',
    ...
    function ResponderMensajes($cedula_est,$cuantos) {
        ?>
        <div class="content-box">
    ...
    function LeerMensajes($cedula,$cuantos) {
        $campos="*";
        $tablas="correos";
