<?php
	...
	$funcionarios = paraTodos::arrayConsulta("*", "expediente e, estatus es, expediente_func ef, funcionarios f", "e.exp_estatus=es.esta_codigo and e.exp_codigo=ef.expf_expcodigo and ef.expf_funcedula=f.fun_cedula and esta_descrip='ASISTENCIA OBLIGATORIA' and e.exp_codigo NOT IN (select asis_expcodigo from asistencia_o ao)");
    $pdf=new PDF(); 
	$pdf->addpage();
    ...
    $pdf->Cell(0,10,'ASISTENCIAS OBLIGATORIAS POR PROCESAR',0,0,'C');
	$pdf->Ln();
