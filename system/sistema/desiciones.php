...
?>
											...
											<fieldset>
												<div class="row">
													<section class="col-ls-6">
															<div class="col col-12">
																<label class="radio">
																	<input type="radio" name="radio" id="procede" value="Procede Destitucion" <?php if( $destitucion == "Procede Destitucion" ) { ?>checked="checked"<?php } ?>>
																	<i></i>Procede Destitución
																</label>
																<label class="radio">
																	<input type="radio" id="improcede" value="Improcede Destitucion" name="radio" <?php if( $destitucion == "Improcede Destitucion" ) { ?>checked="checked"<?php } ?>>
																	<i></i>Improcede Destitución
																</label>
																<label class="radio">
																	<input type="radio" id="otro" value="Otros" name="radio" <?php if( $destitucion == "Otros" ) { ?>checked="checked"<?php } ?>>
																	<i></i>Otros
																</label>
															</div>
													</section>				
												...
												<section>
													<label class="label"><b>Descripción</b></label>
													<label class="textarea"> <i class="icon-append fa fa-comment"></i> 										
														<textarea rows="5" name="descrip" id="descrip" required="required"><?php echo $descrip; ?></textarea> 
													</label>
												</section>
											</fieldset>
											<footer>
